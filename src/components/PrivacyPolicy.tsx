  ...
  return (
    <div className="bg-[#0F172A] text-slate-100 min-h-screen">
      <div className="py-16 space-y-12 pb-24 text-left max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="bg-[#1E293B]/60 border border-slate-800/85 rounded-2xl p-6 sm:p-8 space-y-4 shadow-xl">
          <div className="flex items-start gap-4">
            <div className="p-2 bg-blue-950/40 border border-blue-900/60 rounded-lg text-blue-400 shrink-0 mt-0.5">
              <Lock className="w-5 h-5" />
            </div>
            <div>
              <h2 className="text-lg font-black text-white uppercase tracking-tight mb-2">Our Absolute Commitment</h2>
        ...
        <section className="space-y-8">
          <div className="space-y-6">
            <div className="bg-[#1E293B]/40 p-6 sm:p-8 rounded-2xl border border-slate-800/80 shadow-md space-y-3 hover:border-slate-700/50 transition-all">
        ...
        <section className="pt-8 border-t border-slate-800 text-center space-y-4">
          ...
          {onPageChange && (
            <button
              ...
              className="px-6 py-2.5 bg-[#2563EB] hover:bg-blue-600 active:scale-97 text-white font-black rounded-lg text-xs tracking-wider uppercase transition-all duration-150 cursor-pointer shadow-[4px_4px_0px_#1e3a8a] hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5"
            >
