      ...
      <div className="py-16 space-y-12 pb-24 text-left max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {onPageChange && (
          <button
            ...
            className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-400 hover:text-blue-400 transition-colors cursor-pointer"
          >
        ...
        {/* CORE DISCLAIMER */}
        <section className="bg-[#1E293B]/60 border border-slate-800/85 rounded-2xl p-6 sm:p-8 space-y-6 shadow-xl">
          <div>
            <h2 className="text-lg font-black text-white uppercase tracking-tight mb-4 border-b border-slate-800 pb-2">// Disclaimer</h2>
            ...
            <ol className="space-y-3.5 text-slate-300 text-xs sm:text-sm list-decimal pl-5 leading-relaxed font-medium">
        ...
        <section className="bg-[#1E293B]/40 border border-slate-800/80 rounded-2xl p-6 sm:p-8 space-y-6 shadow-md hover:border-slate-700/50 transition-all">
          <div>
            <h2 className="text-lg font-black text-white uppercase tracking-tight mb-4 border-b border-slate-800 pb-2">// Refund Policy</h2>
            <ol className="space-y-3.5 text-slate-300 text-xs sm:text-sm list-decimal pl-5 leading-relaxed font-medium">
        ...
        <section className="bg-[#1E293B]/60 text-slate-100 p-6 sm:p-8 rounded-2xl border border-slate-800/85 space-y-4 shadow-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            <div className="bg-slate-900/60 border border-slate-800/80 p-4 rounded-xl">
              ...
              <a href="mailto:bsupport@bspsuryatech.in" className="text-blue-400 font-bold hover:underline text-sm block mt-1">
        ...
        <section className="pt-8 border-t border-slate-800 text-center space-y-4">
          ...
          {onPageChange && (
            <button
              ...
              className="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-500 active:scale-97 text-white font-black rounded-lg text-xs tracking-wider uppercase transition-all duration-150 cursor-pointer shadow-[4px_4px_0px_#064e3b] hover:shadow-none hover:translate-x-0.5 hover:translate-y-0.5"
            >
              I Understand & Agree
            </button>
          )}
